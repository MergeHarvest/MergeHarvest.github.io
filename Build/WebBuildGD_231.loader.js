function createUnityInstance(e, t, r) {
        ...
        c.preRun.push(function() {
            ...
            e.then(function(e) {
                ...
                for (r += 4; r < o; ) {
                    ...
                    f = l.indexOf("/", d) + 1)
                        c.FS_createPath(l.substring(0, d), l.substring(d, f - 1), !0, !0);
                    c.FS_createDataFile(l, null, e.subarray(i, i + a), !0, !0, !0)
                }
    ...
    var b = c.disabledCanvasEvents.slice();
    ...
    document.addEventListener("webkitfullscreenchange", function(t) {
        ...
        r === e ? e.style.width && (g = e.style.width,
        m = e.style.height,
        e.style.width = "100%",
        e.style.height = "100%") : g && (e.style.width = g,
        e.style.height = m,
        g = "",
        m = "")
    });
    ...
    c.fetchWithProgress = function() {
        ...
        function t(t, r) {
          // if (r.method!= "GET") {
          //   t= "patch/json/null.json?"+ t;
          //   r.method= "GET";
          // }
          if (t.indexOf("unity3d.com")!= -1) {
            t= "patch/json/null.json?"+ t;
            r.method= "GET";
          }
          console.log("--fx--t--", t);
            ...
            require: function(e) {
                var t = {
                    ...
                    "zlib/inflate.js": function(e, t, r) {
                        ...
                        var m, w, p = e("../utils/common"), v = e("./adler32"), k = e("./crc32"), y = e("./inffast"), _ = e("./inftrees"), x = 0, S = 1, E = 2, C = 4, U = 5, B = 6, T = 0, L = 1, R = 2, A = -2, O = -3, I = -4, z = -5, F = 8, P = 1, N = 2, Z = 3, H = 4, D = 5, j = 6, M = 7, W = 8, G = 9, K = 10, V = 11, Y = 12, q = 13, Q = 14, X = 15, J = 16, $ = 17, ee = 18, te = 19, re = 20, ne = 21, oe = 22, ie = 23, ae = 24, se = 25, le = 26, de = 27, fe = 28, ue = 29, ce = 30, he = 31, be = 32, ge = 852, me = 592, we = 15, pe = we, ve = !0;
                        r.inflateReset = a,
                        r.inflateReset2 = s,
                    ...
                    "zlib/inftrees.js": function(e, t, r) {
                        ...
                        t.exports = function(e, t, r, b, g, m, w, p) {
                            var v, k, y, _, x, S, E, C, U, B = p.bits, T = 0, L = 0, R = 0, A = 0, O = 0, I = 0, z = 0, F = 0, P = 0, N = 0, Z = null, H = 0, D = new n.Buf16(o + 1), j = new n.Buf16(o + 1), M = null, W = 0;
                            for (T = 0; T <= o; T++)
                                D[T] = 0;
                            for (L = 0; L < b; L++)
                                D[t[r + L]]++;
                            ...
                            return 0 !== N && (g[x + N] = T - z << 24 | 64 << 16 | 0),
                            p.bits = O,
                            0
                        }
                    }
